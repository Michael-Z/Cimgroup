...
public class BottomToastDialog {
	...
	public BottomToastDialog(Context context) {
	...
	public BottomToastDialog builder() {
		// 获取Dialog布局
	...
	public BottomToastDialog setTitle(String title) {
		showTitle = true;
	...
	public BottomToastDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public BottomToastDialog setCanceledOnTouchOutside(boolean cancel) {
	 ...
	 * @return
	 */
	public BottomToastDialog addSelectItem(String itemName,
	...
	private void setSelectItems() {
		...
		for (int i = 1; i <= size; i++) {
			...
			if (size == 1) {
				if (showTitle) {
					textView.setBackgroundResource(R.drawable.selector_photo_bottom);
				} else {
					textView.setBackgroundResource(R.drawable.selector_photo_single);
				}
			} else {
				if (showTitle) {
					if (i >= 1 && i < size) {
						textView.setBackgroundResource(R.drawable.selector_photo_middle);
					} else {
						textView.setBackgroundResource(R.drawable.selector_photo_bottom);
					}
				} else {
					if (i == 1) {
						textView.setBackgroundResource(R.drawable.selector_photo_top);
					} else if (i < size) {
						textView.setBackgroundResource(R.drawable.selector_photo_middle);
					} else {
						textView.setBackgroundResource(R.drawable.selector_photo_bottom);
