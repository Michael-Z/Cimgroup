...
public class ProgressWheel extends View {
	...
	/**
	 * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the view, because this method
	 * is called after measuring the dimensions of MATCH_PARENT & WRAP_CONTENT. Use this dimensions to setup
	 * the bounds and paints.
	 */
	@Override
	...
	/**
	 * @return the base spinning speed, in full circle turns per second (1.0 equals on full turn in one
	...
	public interface ProgressCallback {
		...
		/**
		 * Method to call when the progress reaches a value in order to avoid float precision issues, the
		 * progress is rounded to a long with two decimals
		 * 
		 * @param progress
