 ...
 * @Date:2016年1月25日
 */
public class LotteryQxcCartActivity extends LotteryCartActivity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		mTitleTextView.setText(getResources().getString(R.string.lottery_qxc_tz));
		...
		if (obj != null) {
			...
			if (arr != null) {
				for (CodeInfo info : arr) {
					...
					String[] strArr6 = strArr[5].split("\\,");
					String[] strArr7 = strArr[6].split("\\,");
					...
					for (String string : strArr6) {
						list6.add(Integer.parseInt(string));
					}
					
					for (String string : strArr7) {
						list7.add(Integer.parseInt(string));
					}
					setCartLayout(list1, list2, list3, list4, list5, list6, list7);
				}
...
//		mIssueTimeTextView.setText("截止到：" + data.getStringExtra(GlobalConstants.LOTTERY_ISSUE_TIME));
		...
		switch (lottery_type) {
		case GlobalConstants.LOTTERY_QXC_CART:
			...
			ArrayList<Integer> list6 = data.getIntegerArrayListExtra(GlobalConstants.BALL_LIST6);
			ArrayList<Integer> list7 = data.getIntegerArrayListExtra(GlobalConstants.BALL_LIST7);
			if (data.getBooleanExtra(GlobalConstants.CART_IS_ITEM_FORRESULT, false)) {
				bindCartLayout(list1, list2, list3, list4, list5, list6, list7, mClickCartLayout);
			} else {
				if (jxNum > 0) {
					for (int i = 0; i < list1.size(); i++) {
						...
						ArrayList<Integer> tempList6 = new ArrayList<Integer>();
						ArrayList<Integer> tempList7 = new ArrayList<Integer>();
						...
						tempList6.add(list6.get(i));
						tempList7.add(list7.get(i));
						setCartLayout(tempList1, tempList2, tempList3, tempList4, tempList5, tempList6, tempList7);
					}
				} else {
					//从自增加一注点击返回，list为空判断
...
//			int jxNum = data.getIntExtra(GlobalConstants.LIST_JXNUM, 1);
	...
	private void setCartLayout(ArrayList<Integer> list1, ArrayList<Integer> list2, ArrayList<Integer> list3, ArrayList<Integer> list4, ArrayList<Integer> list5, ArrayList<Integer> list6, ArrayList<Integer> list7) {
		CartLayout cartHolder = initSetLayout(mCartLayout);
		initKeep();
		bindCartLayout(new ArrayList<Integer>(list1), new ArrayList<Integer>(list2), new ArrayList<Integer>(list3), new ArrayList<Integer>(list4), new ArrayList<Integer>(list5), new ArrayList<Integer>(list6), new ArrayList<Integer>(list7), cartHolder);
	}

	private void bindCartLayout(ArrayList<Integer> list1, ArrayList<Integer> list2, ArrayList<Integer> list3, ArrayList<Integer> list4, ArrayList<Integer> list5, ArrayList<Integer> list6, ArrayList<Integer> list7, CartLayout cartHolder) {
		...
		int itemNum = list1.size() * list2.size() * list3.size() * list4.size() * list5.size() * list6.size() * list7.size();
		...
		cartHolder.mRLCart.setTag(R.id.tag_list6, list6);
		cartHolder.mRLCart.setTag(R.id.tag_list7, list7);
//		cartHolder.mTVCartType.setText(LotteryBettingUtil.cartQxcType(list1, list2, list3, list4, list5, list6, list7));
		cartHolder.mTVCartType.setText(getResources().getString(R.string.lottery_dlt_zx));
		...
		tv5.setTextColor(redColor);
		tv5.setText("|");
		cartHolder.mFLCartNum.addView(tv5);
		...
		TextView tv6 = new TextView(mActivity);
		tv6.setTextSize(textSize);
		tv6.setTextColor(redColor);
		tv6.setText("|");
		cartHolder.mFLCartNum.addView(tv6);
	...
	protected void itemCartClick(View v) {
		...
		Intent intent = new Intent(mActivity, LotteryQxc2Activity.class);
		...
		intent.putIntegerArrayListExtra(GlobalConstants.BALL_LIST6, (ArrayList<Integer>) v.getTag(R.id.tag_list6));
		intent.putIntegerArrayListExtra(GlobalConstants.BALL_LIST7, (ArrayList<Integer>) v.getTag(R.id.tag_list7));
	...
	public void jxIntoCart() {
		...
		LotteryShowUtil.randomBall(list6, 1, 10);
		LotteryShowUtil.randomBall(list7, 1, 10);
		setCartLayout(list1, list2, list3, list4, list5, list6, list7);
	}

	@Override
	public void zxIntoCart() {
		zxIntent(LotteryQxc2Activity.class);
	}
	...
	public void goBuy(LinearLayout itemLayout, CodeInfo codeInfo) {
		...
		ArrayList<Integer> list6 = (ArrayList<Integer>) itemLayout.getTag(R.id.tag_list6);
		ArrayList<Integer> list7 = (ArrayList<Integer>) itemLayout.getTag(R.id.tag_list7);
		codeInfo.mCode = LotteryBettingUtil.tzQxc(list1, list2, list3, list4, list5, list6, list7);
		codeInfo.mNum = list1.size() * list2.size() * list3.size() * list4.size() * list5.size() * list6.size() * list7.size();
		codeInfo.mPrice = codeInfo.mNum * 2;
		codeInfo.mTypeId = "00";
		codeInfo.mSeleId = LotteryBettingUtil.getSeleID_Qxc(list1, list2, list3, list4, list5, list6, list7);
	}

	@Override
	public String getGameType() {
		return GlobalConstants.TC_QXC;
	}

	@Override
	public String getTitle(String term, int buyType) {
		return getResources().getString(R.string.lottery_qxctz_buytype, term, getBuyTypeTitle(buyType));
	}
