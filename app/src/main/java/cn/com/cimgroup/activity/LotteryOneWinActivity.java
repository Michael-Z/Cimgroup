...
public class LotteryOneWinActivity extends BaseFramentActivity implements
		OnClickListener, PlayMenuItemClick {

	private String gameNo = GlobalConstants.TC_1CZS;
	...
	/**一场制胜*/
	private LotteryOneWinFrament[] mFootBallLotteryjqs = { new LotteryOneWinFrament() };
...
//				mCallBack);
	...
	public void onClick(View v) {
		...
		case R.id.txtView_lotterybid_match_finish:
			frament1.onSuperActivityOnClick(v.getId(),issue);
			break;
		// 更多
		case R.id.textView_title_menu:
			new PopupWndSwitchPLayMenu(LotteryOneWinActivity.this, this)
					.showPopWindow(v);
			break;
		default:
			break;
		...
		public void getFootBallMatchsInfoFailure(final String error) {
			runOnUiThread(new Runnable() {
				...
				public void run() {
					...
					notifyFramentDataChange(null);
					hideLoadingDialog();
					ToastUtil.shortToast(LotteryOneWinActivity.this, error);
				}
			});
		};
...
//							gameNo, "2", mCallBack);
	...
	public void PopDraw() {
		...
		Intent intent1 = new Intent(LotteryOneWinActivity.this,
