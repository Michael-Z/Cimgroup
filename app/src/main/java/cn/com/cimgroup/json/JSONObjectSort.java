 ...
 * Values may be any mix of {@link JSONObjectSort JSONObjects}, {@link JSONArray
 ...
 *       coerced, the sentinel value {@link JSONObjectSort#NULL} is coerced to the
 *       string "null".
 * </ul>
 *
 ...
 * JSONObjectSort#NULL}. In particular, calling {@code put(name, null)} removes the
...
public class JSONObjectSort {
    ...
    public JSONObjectSort(Map copyFrom) {
        this();
     ...
     *     {@code JSONObject}.
     */
    public JSONObjectSort(JSONTokener readFrom) throws JSONException {
        /*
         * Getting the parser to populate this could get tricky. Instead, just
         * parse to temporary JSONObject and then steal the data from that.
         */
        Object object = readFrom.nextValue();
        if (object instanceof JSONObjectSort) {
            this.nameValuePairs = ((JSONObjectSort) object).nameValuePairs;
        } else {
     ...
     *     JSONObject}.
     */
    public JSONObjectSort(String json) throws JSONException {
     ...
     * be skipped.
     */
    public JSONObjectSort(JSONObjectSort copyFrom, String[] names) throws JSONException {
        this();
     ...
     * @return this object.
     */
    public JSONObjectSort put(String name, boolean value) throws JSONException {
     ...
     * @return this object.
     */
    public JSONObjectSort put(String name, double value) throws JSONException {
     ...
     * @return this object.
     */
    public JSONObjectSort put(String name, int value) throws JSONException {
        nameValuePairs.put(checkName(name), value);
        return this;
    }
     ...
     * @return this object.
     */
    public JSONObjectSort put(String name, long value) throws JSONException {
        nameValuePairs.put(checkName(name), value);
        return this;
    }
     ...
     *
     * @param value a {@link JSONObjectSort}, {@link JSONArray}, String, Boolean,
     *     Integer, Long, Double, {@link #NULL}, or {@code null}. May not be
     *     {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
     *     infinities}.
     * @return this object.
     */
    public JSONObjectSort put(String name, Object value) throws JSONException {
        if (value == null) {
     ...
     */
    public JSONObjectSort putOpt(String name, Object value) throws JSONException {
     ...
     */
    public JSONObjectSort accumulate(String name, Object value) throws JSONException {
     ...
     *     JSONObject}.
     */
    public JSONObjectSort getJSONObject(String name) throws JSONException {
        Object object = get(name);
        if (object instanceof JSONObjectSort) {
            return (JSONObjectSort) object;
        } else {
     ...
     */
    public JSONObjectSort optJSONObject(String name) {
        Object object = opt(name);
        return object instanceof JSONObjectSort ? (JSONObjectSort) object : null;
    }
