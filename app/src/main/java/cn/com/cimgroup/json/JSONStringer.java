...
/**
 * Implements {@link JSONObjectSort#toString} and {@link JSONArray#toString}. Most
 ...
 * output. To encode indented output, use {@link JSONObjectSort#toString(int)} or
...
public class JSONStringer {
    ...
    public JSONStringer value(Object value) throws JSONException {
        ...
        } else if (value instanceof JSONObjectSort) {
            ((JSONObjectSort) value).writeTo(this);
            return this;
        }
        ...
        if (value == null
                ...
                || value == JSONObjectSort.NULL) {
            out.append(value);

        } else if (value instanceof Number) {
            out.append(JSONObjectSort.numberToString((Number) value));
    ...
    public JSONStringer value(double value) throws JSONException {
        ...
        beforeValue();
        out.append(JSONObjectSort.numberToString(value));
        return this;
    }
