 ...
 * @Date:2016年1月6日
 */
public class LotteryBasketBallSFCCartAdapter extends BaseLotteryBidOnlyCartAdapter implements
	...
	public LotteryBasketBallSFCCartAdapter(Context context, MatchSearchType searchType, FootballLotteryUtil footballLotteryUtil) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String bfSp = FootballLotteryTools.getMatchSp(match.getMatchAgainstSpInfoList(), GlobalConstants.TC_JLSFC, mSearchType);
...
//			List<Integer> keys = new ArrayList<Integer>(dans.keySet());
	...
	public void onClick(View v) {
		...
		case R.id.txtView_footballlottery_onclick_open:
			...
			// // 弹出选择投注选项dialog
			mDialog.showDialog(DialogType.SFC, mSelectItemIndexs.get(dataPosition), dataPosition, match, mSearchType);
			break;
		// 删除此选项
