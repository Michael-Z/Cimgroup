 ...
 * @Date:2016年1月6日
 */
public class LotteryFootBallBFCartAdapter extends BaseLotteryBidOnlyCartAdapter implements
	...
	public LotteryFootBallBFCartAdapter(Context context, MatchSearchType searchType, FootballLotteryUtil footballLotteryUtil) {
		super(context);
