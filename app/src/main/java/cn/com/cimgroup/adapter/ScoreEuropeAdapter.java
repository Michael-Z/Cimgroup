...
public class ScoreEuropeAdapter extends SimpleBaseAdapter<ScoreDetailOdds> {
	
	public ScoreEuropeAdapter(Context context, MCenterRecordTz centerRecordTz) {
		super(context, null);
	}

	@Override
	public int getItemResource() {
		return R.layout.item_score_europe;
	}
